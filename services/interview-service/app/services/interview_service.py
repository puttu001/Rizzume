...
async def start_interview(
    ...
    question = question_generator.generate_opening_question(role_title)
...
async def submit_answer(
...
) -> tuple[Interview, str | None, dict | None]:
    ...
    if decision.action == "end_interview" or interview.question_count >= MAX_QUESTIONS:
        ...
        return interview, None, feedback_dict
    ...
    return interview, question, None